...
const tournaments = [
  {
    ...
    rules: "Only registered players can participate. Teaming and unregistered players are banned."
  },

  {
    ...
    roomId: "Will be shared",
    password: "Will be shared",
    rules: "Both registered players must join. Teaming with another team is not allowed."
  },

  {
    ...
    roomId: "Will be shared",
    password: "Will be shared",
    rules: "All squad members must be registered. No teaming with other squads."
  },

  {
    ...
    roomId: "Will be shared",
    password: "Will be shared",
    rules: "Players must join on time. Unregistered players will be removed."
  }
];
